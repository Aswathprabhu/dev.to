...
gem "twilio-ruby", "~> 5.26" # The official library for communicating with the Twilio REST API
...
group :development, :test do
  ...
  gem "faker", "~> 2.3" # A library for generating fake data such as names, addresses, and phone numbers
